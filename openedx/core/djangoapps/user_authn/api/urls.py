...
from openedx.core.djangoapps.user_authn.api.optional_fields import OptionalFieldsDataView
...
urlpatterns = [
    ...
    url(r'^optional_fields_description$', OptionalFieldsDataView.as_view(), name='optional_fields'),
]
